        ...
        <div className="grid gap-12 lg:grid-cols-2 lg:gap-16 items-center">
          ...
          <div className="relative hidden lg:flex items-center justify-center">
            <div className="relative">
              {/* Glow behind the can */}
              <div className="absolute inset-0 scale-90 rounded-full bg-[hsl(var(--chart-4)/0.12)] blur-[80px]" />
              <div className="relative w-80 h-80 rounded-full overflow-hidden animate-hero-sway shadow-[0_20px_60px_-10px_rgba(0,0,0,0.15),0_0_40px_hsl(var(--chart-4)/0.1)]">
                <img
                  src={productImage}

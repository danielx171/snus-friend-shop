-- Schedule nightly B2B queue evaluation for operational alerts.
...
BEGIN
  ...
  FROM cron.job
  WHERE jobname = 'ops-b2b-queues-nightly'
  LIMIT 1;
...
SELECT cron.schedule(
  ...
  SELECT net.http_post(
    url := cfg.base_url || '/functions/v1/ops-b2b-queues',
